...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function cadastrarVeiculo() {
        // 1. Pega os valores digitados usando os IDs
        ...
        // 3. Monta o objeto para mandar pro Java (precisa ter os mesmos nomes do Carro.java)
        const dadosCarro = {
            prefixo: prefixo,
            placa: placa,
            combustivel: combustivel
            // Nota: Como 'modelo' fica na tabela tipo_carro, ele exigirá uma lógica extra no Java depois,
            // mas isso já será suficiente para salvar na tabela 'carros' por enquanto.
        };
        ...
        try {
            ...
            if (response.ok) {
                // Abre aquele modal verde escrito "Concluído!" que já está no seu HTML
